...
def im_construction (model):
    if model.eco_manager.exports.get('construction') is None:
        return 0
    else:
        return model.eco_manager.exports['construction']['value']

def im_industrial (model):
    if model.eco_manager.exports.get('industrial production') is None:
        return 0
    else:
        return model.eco_manager.exports['industrial production']['value']

def im_food (model):
    if model.eco_manager.exports.get('food') is None:
        return 0
    else:
        return model.eco_manager.exports['food']['value']
...
def im_catering (model):
    if model.eco_manager.imports.get('catering') is None:
        return 0
    else:
        return model.eco_manager.imports['catering']['value']

def im_commerce (model):
    if model.eco_manager.imports.get('commerce') is None:
        return 0
    else:
        return model.eco_manager.imports['commerce']['value']

def im_transport (model):
    if model.eco_manager.imports.get('transport') is None:
        return 0
    else:
        return model.eco_manager.imports['transport']['value']

def im_hotel (model):
    if model.eco_manager.imports.get('hotel') is None:
        return 0
    else:
        return model.eco_manager.imports['hotel']['value']

def im_public (model):
    if model.eco_manager.imports.get('public administration') is None:
        return 0
    else:
        return model.eco_manager.imports['public administration']['value']
...
def im_health (model):
    if model.eco_manager.imports.get('health') is None:
        return 0
    else:
        return model.eco_manager.imports['health']['value']
...
def im_recreational (model):
    if model.eco_manager.imports.get('recreational activities') is None:
        return 0
    else:
        return model.eco_manager.imports['recreational activities']['value']
...
def im_financial (model):
    if model.eco_manager.imports.get('financial activities') is None:
        return 0
    else:
        return model.eco_manager.imports['financial activities']['value']
...
def im_information (model):
    if model.eco_manager.imports.get('Information and communications') is None:
        return 0
    else:
        return model.eco_manager.imports['Information and communications']['value']
