...
models = []
for k in range(0,3): # extended curfew
    _m = city_model(5000, gdf, max_x, max_y, min_x, min_y, resource_map,shop_restrict=True, c_start=23, c_end=5)
    models.append(_m)
'''
for k in range(3,6): # reduced curfew
    _m = city_model(5000, gdf, max_x, max_y, min_x, min_y, resource_map,curf_restrict=True, c_start=23, c_end=5)
    models.append(_m)
for k in range(6,9): # extended restrictions
    _m = city_model(5000, gdf, max_x, max_y, min_x, min_y, resource_map,shop_restrict=True, c_start=21, c_end=7)
    models.append(_m)
for k in range(9,12): # reduced restrictions
    _m = city_model(5000, gdf, max_x, max_y, min_x, min_y, resource_map,shop_restrict=True, c_start=23, c_end=5)
    models.append(_m)
'''
