...
def doSim(args):
  ...
  plotSEIRHD(t, sir_det, sdfname=os.path.join(args.output_dir,"seirhd.png"))
...
if __name__ == "__main__":  
  ...
  sim.add_argument('--output_dir', type=str, default=os.path.join("results","seird"), help="Output directory" )        
  ...
  fit.add_argument('--output_dir', type=str, default=os.path.join("results","seird"), help="Output directory" )          
