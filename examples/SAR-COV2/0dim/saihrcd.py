...
if __name__ == "__main__":
  ...
  sim.add_argument('--output_dir', type=str, default=os.path.join("results","seihrcd"), help="Output directory" )        
  ...
  fit.add_argument('--output_dir', type=str, default=os.path.join("results","seihrcd"), help="Output directory" )          
