...
from EudaldMobility.experiments import experiment_mean_time_transport, experiment_transport_line_plot, \
    plot_all_routes_agent, plot_box_route_agent, trajectories
...
def main(args):
    ...
    # pollution_trajectories(city.getAgents(), args.steps)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--lockdown', type=dict,
                        default={'inf_threshold': 1, 'night_curfew': 18, 'masks': [0.01, 0.66, 0.33], 'quarantine': 21,
                                 'meeting': 4, 'remote-working': 0.2, 'total_lockdown': False},
                        help="Number of detected infected people to apply health measures")
